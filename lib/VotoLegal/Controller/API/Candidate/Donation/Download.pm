    ...
    while ( my $votolegal_donation = $c->stash->{collection}->next() ) {
        ...
        $csv->print(
            ...
            [
                ...
                $votolegal_donation->{donor_address_state},
                $votolegal_donation->{donor_address_city},
                $votolegal_donation->{donor_address_zipcode},
                $votolegal_donation->{donor_address_district},
                $votolegal_donation->{donor_address_street},
                $votolegal_donation->{donor_address_house_number},
                $votolegal_donation->{donor_address_complement},
