-- Deploy votolegal:0164-update-bank-data to pg
-- requires: 0163-add-colective_name
...
INSERT INTO bank (id, name)
    VALUES
        ...
        ('81',  'Banco Brasileiro de Negócios S.A. - BBN'),
        ('218', 'Banco BS2 S.A.'),
        ...
        ('21',  'Banco do Estado do Espírito Santo - Baneste S.A.'),
        ...
        ('91',  'Central de Cooperativas de Economia e Crédito Mútuo do Estado RS - Unicred'),
        ...
        ('97',  'Cooperativa Central de Crédito Noroeste Brasileiro Ltda. (CentralCredi)'),
        ('85',  'Cooperativa Central de Crédito Urbano - Cecred'),
        ('16',  'Cooperativa de Crédito Mútuo dos Despachantes de Trânsito de Sta.Catarina e RS'),
        ('89',  'Cooperativa de Crédito Rural da Região da Mogiana'),
        ...
        ('93',  'Pólocred Sociedade de Crédito ao Microempreendedor e Empresa de Pequeno Porte'),
